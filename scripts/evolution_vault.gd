...
var vault_upgrades = [
	...
	{"id": "kinetic_reflector", "name": "KINETIC REFLECTOR", "desc": "Dash has a 25% chance to reflect bullets back at enemies.", "cost": 350, "icon": "res://assets/kenney_rune-pack/PNG/Blue/Tile (outline)/runeBlue_tileOutline_015.png"},
