...
var vault_upgrades = [
	...
	{"id": "dash_resistance", "name": "PROTOCOL OVERRIDE", "desc": "Maintains 50% Dash efficiency even when crippled by bosses.", "cost": 750, "icon": "res://assets/kenney_rune-pack/PNG/Blue/Tile (outline)/runeBlue_tileOutline_020.png"}
]
